        ...
        return (
          ...
          >
            ...
            <div className="p-4">
              ...
              <button className="w-full py-2 px-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-semibold hover:shadow-lg transition duration-300">
                View Details
              </button>
            </div>
          </div>
